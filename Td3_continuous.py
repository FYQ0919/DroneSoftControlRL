...
# NUS ID: A0225413R
# Description:
# Use TD3 algorithm to train quadrotor to do compliance motion (Continuous action space)
...
if __name__ == '__main__':
    ...
    while True:
        try:
            ...
            # stats
            bestS, timestep, score, avgvel, avgQ, avgAct,acc_score = 0., 0, 0., 0., 0., 0.,0.
            ...
            while not done and timestep < time_limit:
                ...
                print(f'real_action is {real_action}')
            ...
            stats = [episode, score, actor_loss, critic_loss, 100*acc_score, timestep,avgvel,avgAct]
